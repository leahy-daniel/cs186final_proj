...
public class TestLockManager {
  ...
  @Test
  @Category(StudentTestP3.class)
  public void test2SharedOneExclusive() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
    ...
    thread2.start();
    thread2.join(100);
    assertTrue("Transaction 2 Thread should not have finished", thread2.isAlive());
    ...
    thread3.start();
    thread3.join(100);
    assertFalse("Transaction 1 Second Thread should have finished", thread3.isAlive());
  ...
  @Test
  @Category(StudentTestP3.class)
  public void test2SharedOneExclusiveSameThread() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
    ...
    thread2.start();
    thread2.join(100);
    assertFalse("Transaction 2 Thread should not have finished", thread2.isAlive());
  ...
  @Test
  @Category(StudentTestP3.class)
  public void test2SharedOneExclusiveDifferentThread() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
    ...
    thread3.start();
    thread3.join(100);
    assertTrue("Transaction 1 Second Thread should have finished", thread3.isAlive());
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testUpgradeWithShared() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
    ...
    thread3.start();
    thread3.join(100);
    assertTrue("Transaction 1 Second Thread should not have finished", thread3.isAlive());
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testUpgradeOn2() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testExOn2() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
  ...
  @Test
  @Category(StudentTestP3.class)
  public void test4Shared() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testExclusiveBlock() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.EXCLUSIVE);
  ...
  @Test
  @Category(StudentTestP3.class)
  public void test2SharedWithRelease() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
